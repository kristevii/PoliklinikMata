...
<head>
    ...
    <title>Halaman Tidak Ditemukan - Sistem Informasi Poliklinik Mata Eyethica</title>
    <!-- [Favicon] icon -->
...
<?php
// Mengirimkan header HTTP 404 Not Found
...
<div class="main-container">
    <div class="content-side">
        ...
        <div class="error-content">
            <i class="fas fa-map-signs" style="color: var(--primary-blue); font-size: 4.5rem; margin-bottom: 20px;"></i>
            <h1>Halaman Tidak Ditemukan</h1>
            <p class="subtitle">
                Maaf, halaman yang Anda cari tidak dapat ditemukan atau telah dipindahkan. Periksa kembali URL yang Anda masukkan.
            </p>
    ...
    <div class="visual-side">
        <div>
            ...
            <div class="visual-title">
                ...
                <p>Sepertinya Anda tersesat.<br>Mari kembali ke jalur yang benar.</p>
            </div>
        </div>
        ...
        <div style="z-index: 1;">
            <p style="font-size: 14px; opacity: 0.7; max-width: 300px;">
                Jika Anda yakin URL ini seharusnya ada, silakan hubungi tim IT Poliklinik Mata Eyethica.
            </p>
        </div>
    </div>
</div>
